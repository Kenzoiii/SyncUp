-- =====================================================
-- SyncUp Database Setup Script for MySQL Workbench
-- =====================================================
...
-- Step 11: Create User Scores Table (for gamification)
...
SELECT '===============================================' as separator;
SELECT 'Test Admin User Created:' as info;
SELECT 'Email: admin@syncup.com' as email;
SELECT 'Password: password123' as password;
SELECT '===============================================' as separator;
SELECT 'You can now start the backend server!' as next_step;
SELECT '===============================================' as separator;
